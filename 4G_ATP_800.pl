...
print ("#############################################################\n");
print ("#            4G 800 ATP EXECUTION AND VERIFY TOOL           #\n");
print ("# TOOL WILL CREATE AND EXECUTE ATP BATCH AND VERIFY RESULTS #\n");
print ("#############################################################\n\n");

my $validate = `C:\\3G_4G_TOOL_Scripts\\bin\\validate_ran.exe`;
chomp ($validate);
...
print ("\n4G 800 ATP WILL BE PERFORMED ON\n\nLSM: $lsm_selected\nENODEB: $enodeb\nENODEB NUMBER: $enode_num\nBUCKET: $bucket\nIP: $ip\n\n");
...
if (($split_CELL_CONF =~ m/^15 /) || ($split_CELL_CONF =~ m/^16 /) || ($split_CELL_CONF =~ m/^17 /)) {
...
&CHG_CELL_CONF(15,unlocked);
&CHG_CELL_CONF(16,unlocked);
&CHG_CELL_CONF(17,unlocked);
...
sub CHG_RRH_CONF {			#START CHG_RRH_CONF SUBROUTINE
if ($hash_cell_status{$_[0]} eq "EQUIP") {
$ssh->print("cmd $enodeb CHG-RRH-CONF:CONNECT_BOARD_ID=$_[1],CONNECT_PORT_ID=$_[2],POWER_BOOST=\'\"OFF,OFF,OFF,OFF\"\'");		   
$ssh->waitfor("]");
$ssh->waitfor("]");
my $CHG_RRH_CONF_0 = $ssh->waitfor(';');
$CHG_RRH_CONF_0 = "$CHG_RRH_CONF_0$colon";
print ("$CHG_RRH_CONF_0\n");
$value .= "$CHG_RRH_CONF_0";
                                         }


                 }			#END CHG_RRH_CONF SUBROUTINE
######################
#  END CHG-RRH-CONF  #
######################
...
if (($_[0] eq "15") || ($_[0] eq "16") || ($_[0] eq "17")) {
if ($_[1] eq "disabled") {
$disable_count++;
                         }
...
#print Dumper(\%hash_CELL_STS_OP_STATE);

if ($equip_count ne "$disable_count") {		#START IF $equip_count ne $disable_count			  
my ($error_num, $error);

#&ERROR_CELL_DISABLE(15);
#&ERROR_CELL_DISABLE(16);
#&ERROR_CELL_DISABLE(17);
...
if ($error_num == 1) {
&CHG_CELL_CONF(15,locked);
&CHG_CELL_CONF(16,locked);
&CHG_CELL_CONF(17,locked);
...
&TEST_TXPWR(15,2,3,NO_OCNS,TEST_TXPWR,0);
&TEST_TXPWR(16,2,4,NO_OCNS,TEST_TXPWR,0);
&TEST_TXPWR(17,2,5,NO_OCNS,TEST_TXPWR,0);
...
#if ($pkg eq "2.5.0") {
#$ssh->print("TEST-TXPWR:RRH,$_[1],$_[2];");
#                     }
#else {
...
&TEST_VSWR(15,2,3,NO_OCNS,TEST_VSWR,0);
&TEST_VSWR(16,2,4,NO_OCNS,TEST_VSWR,0);
&TEST_VSWR(17,2,5,NO_OCNS,TEST_VSWR,0);
...
&TEST_OCNS(15,OCNS_SET);
&TEST_OCNS(16,OCNS_SET);
&TEST_OCNS(17,OCNS_SET);
...
#####################################
&TEST_TXPWR(15,2,3,OCNS,TEST_TXPWR,1);
&TEST_TXPWR(16,2,4,OCNS,TEST_TXPWR,1);
&TEST_TXPWR(17,2,5,OCNS,TEST_TXPWR,1);
#####################################
...
####################################
&TEST_VSWR(15,2,3,OCNS,TEST_VSWR,1);
&TEST_VSWR(16,2,4,OCNS,TEST_VSWR,1);
&TEST_VSWR(17,2,5,OCNS,TEST_VSWR,1);
####################################
...
#####################################
&TEST_TXPWR(15,2,3,OCNS,TEST_TXPWR,2);
&TEST_TXPWR(16,2,4,OCNS,TEST_TXPWR,2);
&TEST_TXPWR(17,2,5,OCNS,TEST_TXPWR,2);
#####################################
...
####################################
&TEST_VSWR(15,2,3,OCNS,TEST_VSWR,2);
&TEST_VSWR(16,2,4,OCNS,TEST_VSWR,2);
&TEST_VSWR(17,2,5,OCNS,TEST_VSWR,2);
####################################
...
#####################################
&TEST_TXPWR(15,2,3,OCNS,TEST_TXPWR,3);
&TEST_TXPWR(16,2,4,OCNS,TEST_TXPWR,3);
&TEST_TXPWR(17,2,5,OCNS,TEST_TXPWR,3);
#####################################
...
####################################
&TEST_VSWR(15,2,3,OCNS,TEST_VSWR,3);
&TEST_VSWR(16,2,4,OCNS,TEST_VSWR,3);
&TEST_VSWR(17,2,5,OCNS,TEST_VSWR,3);
####################################
...
&TERM_TEST(15,0,TERM_OCNS);
&TERM_TEST(16,1,TERM_OCNS);
&TERM_TEST(17,2,TERM_OCNS);
...
###########################
open (FILE, ">$Bin\\DATA_COLLECTED\\ATP_4G_800\_$cascade\_$eNB$enode_num\_$year$month$mday\.txt");

if (($hash_CELL_STS_OP_STATE{15} eq "disabled") || ($hash_CELL_STS_OP_STATE{16} eq "disabled") || ($hash_CELL_STS_OP_STATE{17} eq "disabled")) {
...
# START REPORT #
################
open (HTMLFILE, ">$Bin\\REPORTS\\4G_800_ATP_Report\_$cascade\_$eNB$enode_num\_$year$month$mday\.html");

print (HTMLFILE "<table width=100% cellspacing=0 cellpadding=5 border=0>\n");
print (HTMLFILE "<tr><td align=center><font size=+3>$cascade $eNB$enode_num 4G 800 ATP REPORT  For $day $month_full $mday $year $hour:$minute:$second</font></td></tr>\n");
if (($hash_CELL_STS_OP_STATE{15} eq "disabled") || ($hash_CELL_STS_OP_STATE{16} eq "disabled") || ($hash_CELL_STS_OP_STATE{17} eq "disabled")) {
...
########################################
print (HTMLFILE "<table width=100% cellspacing=0 cellpadding=5 border=1 bordercolor=#000000>\n");
print (HTMLFILE "<tr><td colspan=6 align=center bgcolor=#FFFF00><b>TEST_TYPE_TXPOWER WITHOUT OCNS</b></td></tr>\n");
print (HTMLFILE "<tr>\n");
...
if (($RSSI <= -97) && ($RSSI > -102)) {
print (HTMLFILE "<td bgcolor=#FFFF00>$RSSI</td>\n");
                                      }
...
if ($RSSI < -108) {
print (HTMLFILE "<td bgcolor=#FF00>$RSSI</td>\n");
                 }
...
if (($RSSI_1 <= -97) && ($RSSI_1 > -102)) {
print (HTMLFILE "<td bgcolor=#FFFF00>$RSSI_1</td>\n");
                                          }
...
#####################################
print (HTMLFILE "<table width=100% cellspacing=0 cellpadding=5 border=1 bordercolor=#000000>\n");
print (HTMLFILE "<tr><td colspan=6 align=center bgcolor=#FFFF00><b>TEST_TYPE_TXPOWER WITH OCNS (FIRST PASS)</b></td></tr>\n");
print (HTMLFILE "<tr>\n");
print (HTMLFILE "<th>BoardId</th>\n");
print (HTMLFILE "<th>PortId</th>\n");
print (HTMLFILE "<th>RF Pwr(Port 0)</th>\n");
...
#####################################
print (HTMLFILE "<table width=100% cellspacing=0 cellpadding=5 border=1 bordercolor=#000000>\n");
print (HTMLFILE "<tr><td colspan=6 align=center bgcolor=#FFFF00><b>TEST_TYPE_TXPOWER WITH OCNS (SECOND PASS)</b></td></tr>\n");
print (HTMLFILE "<tr>\n");
print (HTMLFILE "<th>BoardId</th>\n");
print (HTMLFILE "<th>PortId</th>\n");
print (HTMLFILE "<th>RF Pwr(Port 0)</th>\n");
...
#####################################
print (HTMLFILE "<table width=100% cellspacing=0 cellpadding=5 border=1 bordercolor=#000000>\n");
print (HTMLFILE "<tr><td colspan=6 align=center bgcolor=#FFFF00><b>TEST_TYPE_TXPOWER WITH OCNS (THIRD PASS)</b></td></tr>\n");
print (HTMLFILE "<tr>\n");
print (HTMLFILE "<th>BoardId</th>\n");
print (HTMLFILE "<th>PortId</th>\n");
print (HTMLFILE "<th>RF Pwr(Port 0)</th>\n");
