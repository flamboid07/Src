...
print ("#########################################\n");
print ("# RAN COMMISSIONING 3G Carrier Harvest PreCheck TOOL #\n");
print ("#########################################\n");
...
print ("$bts_id\n");
open (FILE, ">$Bin\\DATA_COLLECTED\\$cascade\_$bts_id\_3G_Carrier_Harvest_PreCheck_LOGS\_$month_num\_$mday\_$year\_$hour\_$minute\_$second\.txt");
...
#####################################
$ssh->print("cmdx 1 RTRV-SUBC-STS:BTS=$bts_id:3");
$ssh->waitfor(';');
