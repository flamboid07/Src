...
my ($secondcar,$divciq,$convert_long,$convert_lat,$tddsecondcar,$tdd3rdcar,$thirdcar,$dblsmpwd);
my($now);
...
if (!$conncet) {
print ("Not Connected to MC - please check UID and MC password - password used was $dblsmpwd\n");
sleep(5);
};
...
if (($info =~ m/_4.0/) || ($info =~ m/_5.0/))  || ($info =~ m/6.5/) {
$database_name = "mc_db";
                                                                    }
else {
...
$ssh_lsm->print('exit');
$ssh_lsm->waitfor(']'); # exit mysql on the MC server
...
print("cmd $eNBName RTRV-PKG-VER;"); 
...
if ($pkg =~ m/^5/) {
if ($timer_data eq "3000,3000,5000,2000,2000,100,5000,300,5000,5000,Three,5,10000,5000,3000,2000,5000,2000,5000,5,5000,Three,5,2000,5000,10000,Three,2000,100,2000,40,2000,2000,2000,2000,5000,5000,5000,5000,2000,5000,100,5000,5000,1000,1000,3000,3000,1280,180,2,9,3,3,10000") {
...
if ($pkg =~ m/^5/){
print (HTMLFILE "<tr><th align=center>CELL_NUM</th><th align=center>PURPOSE</th><th align=center>FA_INDEX</th><th align=center>ACTIVE_STATE</th><th align=center>A2_THRESHOLD_RSRP[dBm]</th><th align=center>A2_THRESHOLD_RSRQ[dB]</th><th align=center>HYSTERESIS</th><th align=center>TIME_TO_TRIGGER[ms]</th><th align=center>TRIGGER_QUANTITY</th><th align=center>REPORT_QUANTITY</th><th align=center>MAX_REPORT_CELL</th><th align=center>REPORT_INTERVAL[ms]</th><th align=center>REPORT_AMOUNT</th></tr>\n");			      
}
...
if ($pkg =~ m/^5/){
if (($_[0] <= "11") && ($_[1] eq "LteHo")&&($_[2] eq "0")){
